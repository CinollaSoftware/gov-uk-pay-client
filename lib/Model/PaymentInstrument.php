 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentInstrument implements ModelInterface, ArrayAccess
{
     ...
     * Sets created_date
     *
     * @param string $created_date The date and time you created this payment instrument. This value uses Coordinated Universal Time (UTC) and ISO 8601 format – `YYYY-MM-DDThh:mm:ss.sssZ`.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The type of payment instrument.
     *
     * @return $this
     */
