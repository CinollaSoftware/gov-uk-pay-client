 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SettlementSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettlementSummary';
     ...
     * Sets settled_date
     *
     * @param string $settled_date The date your payment service provider took the disputed payment and dispute fee from a payout to your bank account. This value appears in ISO 8601 format - `YYYY-MM-DD`. `settled_date` only appears if you lost the dispute.
     *
     * @return $this
     */
